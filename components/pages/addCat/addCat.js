    ...
    items: [
      {
        name: "白",
        checked: 0,
        src: "../../images/catColor/white.png",
        selected_src: "../../images/catColor/_white.png",
        color: 0,
      },
      {
        name: "狸花",
        checked: 0,
        src: "../../images/catColor/huablack.png",
        selected_src: "../../images/catColor/_huablack.png",
        color: 1,
      },
      {
        name: "黑白",
        checked: 0,
        src: "../../images/catColor/blackwhite.png",
        selected_src: "../../images/catColor/_blackwhite.png",
        color: 2,
      },
      {
        name: "狸花加白",
        checked: 0,
        src: "../../images/catColor/sanblack.png",
        selected_src: "../../images/catColor/_sanblack.png",
        color: 3,
      },
      {
        name: "三花",
        checked: 0,
        src: "../../images/catColor/YBW.png",
        selected_src: "../../images/catColor/_YBW.png",
        color: 4,
      },

      {
        name: "黑",
        checked: 0,
        src: "../../images/catColor/black.png",
        selected_src: "../../images/catColor/_black.png",
        color: 5,
      },
      {
        name: "虎皮橘",
        checked: 0,
        src: "../../images/catColor/huayellow.png",
        selected_src: "../../images/catColor/_huayellow.png",
        color: 6,
      },
      {
        name: "橘白",
        checked: 0,
        src: "../../images/catColor/YW.png",
        selected_src: "../../images/catColor/_YW.png",
        color: 7,
      },
      {
        name: "虎皮橘加白",
        checked: 0,
        src: "../../images/catColor/YOW.png",
        selected_src: "../../images/catColor/_YOW.png",
        color: 8,
      },
...

      {
        name: "橘",
        checked: 0,
        src: "../../images/catColor/yellow.png",
        selected_src: "../../images/catColor/_yellow.png",
        color: 10,
      },
...

      {
        name: "橘黑",
        checked: 0,
        src: "../../images/catColor/blackyellow.png",
        selected_src: "../../images/catColor/_blackyellow.png",
        color: 12,
      },
    ],
  },
